...
<body class="img js-fullheight" style="background-image: url(images/upcoming.png);">
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 custom-sidebar" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link text-white active bg-warning" href="upcomingReservation.jsp">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
...
<main>
<br>
    <h2 style="text-align: center;">Upcoming Reservations</h2>
